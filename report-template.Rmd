...
animal.grouping.vars <-
  c("country", "concurrent_sampling_site", "site_name", "disease_transmission_interfaces", "human_density_impact", 
    "class", "taxa_group_mod", "scientific_name", "test_requested", "viral_species", "human_threat", "specimen_type")
...
write_csv(animal_viral_pairs, h("data", "animal_viral_pairs", paste0(report_country, "_animal_viral_pairs.csv")))
```
