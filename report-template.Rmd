...
animal.grouping.vars <-
  c("country", "concurrent_sampling_site", "site_name", "disease_transmission_interfaces", "human_density_impact", 
    "class", "taxa_group_mod", "scientific_name", 
...
# test = d2_country %>% filter(concurrent_sampling_site == "Concurrent Site 1", site_name == "Chonburi-Wat Luang Temple", viral_species == "Nipah virus")
# test %>% janitor::get_dupes(animal_human_id) %>% select(animal_human_id, specimen_id)
