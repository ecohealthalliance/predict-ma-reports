...
viral.species.detected.in.country <- animal_viral_pairs %>%
...
for(vir in viral.species.detected.in.country) {
  ...
  species_detects <- animal_viral_pairs %>%
    filter(
      viral_species == vir, 
      species_scientific_name %in% unique(iucn_detects$binomial), 
  ...
  species_non_detects <- animal_viral_pairs %>%
    filter(
      viral_species == vir, 
      species_scientific_name %in% species_detects$species_scientific_name, 
      n_animals_w_detections == 0
    )
