...
pal_mammal <- colorBin(palette = c("azure4", "yellow", "coral2"), domain = -1:max_val_mammal, na.color = "transparent")
...
leaflet() %>% 
  ...
  addLegend(pal = pal_mammal, values = values(mammal_dens), group = "Mammal", position = "bottomright",
            title = "Mammal Population Density" , labFormat = labelFormat(digits = 0 ,transform = function(x) 10 ^ x)) %>%
  # User controlled layers
  addLayersControl(overlayGroups  = c("Human", "Mammal"),
