...
mz <- read_csv(h("data", "hp3_zoo_predictions.csv")) %>%
  mutate(
    species = case_when(
      species == "Pipistrellus_pulveratus" ~ "Hypsugo pulveratus",
...
text.color <- ifelse(mz$species %in% species.sampled.in.country, "#1B8925", "#BD0505")
