...
#### _Click on the "Expand / Collapse" buttons to expand sections._
...
get_country_viruses(view = FALSE, animal_virus_summary) %>%
  ...
  datatable(class = "row-border", escape = FALSE, rownames = FALSE, 
            ...
            callback = JS("$(function () {$('[data-toggle=\"tooltip\"]').tooltip()})")
  )
```
</div>
...
#### Sampling Prioritization Based on Predicted 'Missing' Zoonoses
